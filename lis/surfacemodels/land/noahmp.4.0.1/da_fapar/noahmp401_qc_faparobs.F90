...
!BOP
! !ROUTINE: noahmp401_qc_faparobs
! \label{noahmp401_qc_faparobs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_qc_faparobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  call LIS_verify(status,&
       "ESMF_StateGet failed in NoahMP401_qc_faparobs")
...
end subroutine noahmp401_qc_faparobs
