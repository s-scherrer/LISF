...
!   \item[wsfpar]
!     fraction of diffuse photosyn. active solar radiation absorbed by vegetation. unit: -
!   \item[rssun]
...
!       real               :: fsh
        ...
        real               :: bsfpar ! fraction of direct absorbed PAR
        real               :: wsfpar ! fraction of diffuse absorbed PAR
        real               :: psn
        real               :: sav
        real               :: sag
        real               :: rssun
