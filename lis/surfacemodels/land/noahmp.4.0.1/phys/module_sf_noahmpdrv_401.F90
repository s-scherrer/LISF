  ...
  SUBROUTINE noahmplsm_401(LIS_undef_value,                                       & ! IN : LIS undefined value
		...
		ACSNOW,    EMISS,     QSFC,                                 & ! IN/OUT LSM eqv
	       ...
	       RUNSBXY,   ECANXY,   EDIRXY,   ETRANXY,    FSAXY,    FIRAXY, & ! OUT Noah MP only
	        APARXY,    PSNXY,    SAVXY,     SAGXY,   PSAVXY,  BSFPARXY, & ! OUT Noah MP only
              WSFPARXY,  RSSUNXY,   RSSHAXY,                                & ! OUT Noah MP only
...
!   REAL,    DIMENSION( ims:ime,          jms:jme ), INTENT(INOUT) ::  ALBEDO    ! total grid albedo []
    ...
    REAL,    DIMENSION( ims:ime,          jms:jme ), INTENT(INOUT) ::  MAXLAIXY  ! 
...
! OUT (with no Noah LSM equivalent)
    ...
    REAL,    DIMENSION( ims:ime,          jms:jme ), INTENT(OUT  ) ::  BSFPARXY  ! 
    REAL,    DIMENSION( ims:ime,          jms:jme ), INTENT(OUT  ) ::  WSFPARXY  ! 
...
!         ZWT    = LIS_undef_value 
         ...
         BSFPAR = LIS_undef_value 
         WSFPAR = LIS_undef_value 
