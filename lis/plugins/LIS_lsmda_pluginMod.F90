...
contains
    ...
    subroutine register_noahmp401_laida(obsId, maxlaiupdate)
        implicit none
        character*50, intent(in) :: obsId
    ...
    subroutine register_noahmp401_faparda(obsId, type, maxlaiupdate)
        ...
        !
        ! The state variable related routines are therefore the
        ! same as in the case of LAI DA, only the observations
        ! are different.
        implicit none
        character*50, intent(in) :: obsId
