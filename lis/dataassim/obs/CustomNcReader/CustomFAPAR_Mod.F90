...
module CustomFAPAR_Mod
    ...
    public :: CustomFAPAR_setup, read_CustomFAPAR, write_CustomFAPAR
...
contains
    ...
    subroutine CustomFAPAR_setup(k, OBS_State, OBS_Pert_State)
        ...
        do n=1,LIS_rc%nnest
            CustomFAPAR_struc(n)%obsid = "Custom FAPAR"
    ...
    end subroutine CustomFAPAR_setup
